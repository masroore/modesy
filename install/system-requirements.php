                                    ...
                                    <div class="col-sm-11">
                                        <p>
                                            ...
                                            <?php if (PHP_VERSION >= 5.6): ?>
                                                <strong class="color-success"><?php echo PHP_VERSION; ?></strong>
                                            <?php else: ?>
                                                <strong class="color-danger"><?php echo PHP_VERSION; ?>&nbsp;<small>(Your PHP version must be 5.6 or greater)</small>
                                                </strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
