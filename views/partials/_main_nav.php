                                                ...
                                                <?php if (!empty($category->image_1) && $category->show_image_on_navigation == 1): ?>
                                                    <div class="nav-category-image">
                                                        <a href="<?php echo generate_category_url($category); ?>">
                                                            <img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($category, 'image_1'); ?>" alt="<?php echo html_escape($category->name); ?>" class="lazyload img-fluid">
                                                            <span><?php echo html_escape(character_limiter($category->name, 20, '..')); ?></span>
                                                        </a>
                                                    </div>
                                                <?php endif; ?>
