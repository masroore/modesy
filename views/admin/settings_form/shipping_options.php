                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                                ...
                                <?php foreach ($shipping_options as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo html_escape($item->option_label); ?></td>
                                        <td>
                                            <?php if ($item->shipping_cost == 1): ?>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>form-settings/edit-shipping-option/<?php echo $item->id; ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('settings_controller/delete_shipping_option_post','<?php echo $item->common_id; ?>','<?php echo trans("confirm_option"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
